...
namespace Kusog.Mvc
{
    public class WrapAction : ActionExtension
    {
        public WrapAction() { }

        public WrapAction(string before, string after="")
        {
        ...
        {
            CompoundResult(filterContext).WrapResults(BeforeContent, AfterContent);
        }
    }
}
